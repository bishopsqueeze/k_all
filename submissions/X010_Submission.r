...
## Set the working directory
##------------------------------------------------------------------
setwd("/Users/alexstephens/Development/kaggle/allstate/data/gbm_scored_X010")
...
##******************************************************************
write.csv(lastquoted.fin,                               file="X010_lastquoted.csv", row.names=FALSE)
write.csv(gbm_gonly.fin,                                file="X010_gbm_gonly.csv", row.names=FALSE)
