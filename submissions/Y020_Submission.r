...
## Set the working directory
##------------------------------------------------------------------
setwd("/Users/alexstephens/Development/kaggle/allstate/data/rf_scored_X020")
...
##******************************************************************
write.csv(lastquoted.fin,   file="Y020_lastquoted.csv", row.names=FALSE)
write.csv(gbm_gonly.fin,    file="Y020_rf_gonly.csv", row.names=FALSE)
