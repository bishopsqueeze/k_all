...
## Set the working directory
##------------------------------------------------------------------
setwd("/Users/alexstephens/Development/kaggle/allstate/data/gbm_scored_X008")
...
##******************************************************************
write.csv(lastquoted.fin,                               file="X008_lastquoted.csv", row.names=FALSE)
write.csv(gbm_gonly.fin,                                file="X008_gbm_gonly.csv", row.names=FALSE)
