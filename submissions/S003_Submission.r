...
## Set the working directory
##------------------------------------------------------------------
setwd("/Users/alexstephens/Development/kaggle/allstate/data/gbm_scored_S003")
...
##******************************************************************
write.csv(lastquoted.sub, file="S003_lastquoted.csv", row.names=FALSE)
#write.csv(gbm_aonly.sub,  file="S003_gbm_aonly.csv", row.names=FALSE)
#write.csv(gbm_bonly.sub,  file="S003_gbm_bonly.csv", row.names=FALSE)
#write.csv(gbm_conly.sub,  file="S003_gbm_conly.csv", row.names=FALSE)
#write.csv(gbm_donly.sub,  file="S003_gbm_donly.csv", row.names=FALSE)
#write.csv(gbm_eonly.sub,  file="S003_gbm_eonly.csv", row.names=FALSE)
#write.csv(gbm_fonly.sub,  file="S003_gbm_fonly.csv", row.names=FALSE)
write.csv(gbm_gonly.sub,  file="S003_gbm_gonly.csv", row.names=FALSE)
#write.csv(gbm_all.sub,    file="S003_gbm_all.csv", row.names=FALSE)

#write.csv(gbm_cdonly.sub, file="S003_gbm_cdonly.csv", row.names=FALSE)
#write.csv(gbm_afonly.sub, file="S003_gbm_afonly.csv", row.names=FALSE)
#write.csv(gbm_beonly.sub, file="S003_gbm_beonly.csv", row.names=FALSE)
